(function() {
  ...
  module.exports = ArchiveEditorView = (function(_super) {
    ...
    ArchiveEditorView.prototype.initialize = function(editor) {
      ArchiveEditorView.__super__.initialize.apply(this, arguments);
    ...
    ArchiveEditorView.prototype.refresh = function() {
      ...
      return archive.list(this.path, {
        ...
        return function(error, entries) {
          ...
          if (error != null) {
            return console.error("Error listing archive file: " + _this.path, (_ref = error.stack) != null ? _ref : error);
          } else {
    ...
    ArchiveEditorView.prototype.setModel = function(editor) {
      ...
      if (editor) {
        ...
        editor.file.on('contents-changed', (function(_this) {
          return function() {
            return _this.refresh();
          };
        })(this));
        return editor.file.on('removed', (function(_this) {
          return function() {
            var _ref;
            return (_ref = _this.parents('.pane').view()) != null ? _ref.destroyItem(editor) : void 0;
          };
        })(this));
      }
    };
