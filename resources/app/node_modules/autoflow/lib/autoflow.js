(function() {
  module.exports = {
    activate: function() {
      return atom.workspaceView.eachEditorView((function(_this) {
        return function(editorView) {
          ...
          return editorView.command('autoflow:reflow-selection', function() {
            return _this.reflowSelection(editorView.editor);
          });
        };
      })(this));
    },
    reflowSelection: function(editor) {
      ...
      if (range != null) {
        return editor.getBuffer().change(range, this.reflow(editor.getTextInRange(range), {
          wrapColumn: this.getPreferredLineLength()
        }));
      }
    },
    ...
    getPreferredLineLength: function() {
