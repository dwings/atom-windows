(function() {
  ...
  module.exports = TreeView = (function(_super) {
    ...
    TreeView.prototype.showSelectedEntryInFileManager = function() {
      var args, command, entry, errorLines, exit, label, stderr, _ref1;
      entry = this.selectedEntry();
      if (!entry) {
        return;
      }
      _ref1 = this.fileManagerCommandForPath(entry.getPath(), entry instanceof FileView), command = _ref1.command, args = _ref1.args, label = _ref1.label;
      errorLines = [];
