(function() {
  var $$$, PackageSnippetsView, View, path, _, _ref,
  ...
  module.exports = PackageSnippetsView = (function(_super) {
    ...
    PackageSnippetsView.prototype.getSnippetProperties = function() {
      ...
      packageProperties = {};
      _ref1 = atom.syntax.propertyStore.propertySets;
    ...
    PackageSnippetsView.prototype.getSnippets = function(callback) {
      ...
      if ((snippetsPackage != null ? snippetsPackage.mainModule : void 0) != null) {
        if (snippetsPackage.mainModule.loaded) {
          return callback(this.getSnippetProperties());
        } else {
          return this.subscribe(atom.packages.once('snippets:loaded', (function(_this) {
            return function() {
