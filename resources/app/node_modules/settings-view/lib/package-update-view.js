(function() {
  ...
  module.exports = PackageUpdateView = (function(_super) {
    ...
    PackageUpdateView.prototype.initialize = function(pack, packageManager) {
      ...
      this.latestVersion.text("Version " + this.pack.latestVersion + " is now available. " + this.pack.version + " is currently installed.");
      ...
      this.subscribeToPackageEvent('package-updated theme-updated package-update-failed theme-update-failed', (function(_this) {
        return function(pack, error) {
          ...
          if (error != null) {
            ...
            return _this.setStatusIcon('check');
          }
        };
      })(this));
    ...
    PackageUpdateView.prototype.setStatusIcon = function(iconName) {
      ...
      switch (iconName) {
        case 'check':
          return this.status.setTooltip(_.capitalize("" + this.type + " updated"));
        case 'alert':
          return this.status.setTooltip(_.capitalize("" + this.type + " failed to updated"));
        case 'cloud-download':
          return this.status.setTooltip(_.capitalize("" + this.type + " updating"));
      }
    };
