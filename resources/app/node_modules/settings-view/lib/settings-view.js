(function() {
  var $, $$, CSON, GeneralPanel, InstalledPackageView, KeybindingsPanel, PackageManager, PackageMenuView, PackagesPanel, ScrollView, SettingEditorView, SettingsView, ThemesPanel, async, fuzzaldrin, path, _, _ref,
          ...
          _this.div({
            ...
            _this.ul({
              ...
              return _this.div({
                ...
                return _this.subview('filterEditor', new SettingEditorView({
