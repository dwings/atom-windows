(function() {
  ...
  module.exports = FindView = (function(_super) {
    ...
    FindView.prototype.handleEvents = function() {
      ...
      this.subscribe(this.findModel, 'find-error', this.findError);
    ...
    FindView.prototype.showFind = function() {
      ...
      selectedText = (_ref1 = atom.workspace.getActiveEditor()) != null ? typeof _ref1.getSelectedText === "function" ? _ref1.getSelectedText() : void 0 : void 0;
