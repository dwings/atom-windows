(function() {
  ...
  module.exports = {
    ...
    activate: function(_arg) {
      ...
      atom.workspaceView.command('project-find:toggle', (function(_this) {
        return function() {
          var _ref1;
          _this.createProjectFindView();
          if ((_ref1 = _this.findView) != null) {
          ...
          if (_this.projectFindView.hasParent()) {
            return _this.projectFindView.detach();
          } else {
            return _this.projectFindView.attach();
          }
        };
      ...
      atom.workspaceView.command('find-and-replace:toggle', (function(_this) {
        return function() {
          var _ref1;
          _this.createFindView();
          ...
          if (_this.findView.hasParent()) {
            return _this.findView.detach();
          } else {
            return _this.findView.showFind();
          }
        };
      ...
      atom.workspaceView.on('core:cancel core:close', (function(_this) {
        return function(_arg1) {
          var editor, target, _ref1, _ref2, _ref3;
          target = _arg1.target;
          if (target !== ((_ref1 = atom.workspaceView.getActivePaneView()) != null ? _ref1[0] : void 0)) {
            editor = $(target).parents('.editor:not(.mini)');
            if (!editor.length) {
              return;
            }
          }
          if ((_ref2 = _this.findView) != null) {
            _ref2.detach();
          }
          return (_ref3 = _this.projectFindView) != null ? _ref3.detach() : void 0;
        };
      })(this));
