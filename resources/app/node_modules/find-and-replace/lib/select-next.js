(function() {
  ...
  module.exports = SelectNext = (function() {
    ...
    SelectNext.prototype.selectNextOccurrence = function() {
      var range;
      range = this.findNextOccurrence([this.editor.getSelection().getBufferRange().end, this.editor.getEofBufferPosition()]);
      if (range == null) {
        range = this.findNextOccurrence([[0, 0], this.editor.getSelection(0).getBufferRange().start]);
      }
      if (range != null) {
