(function() {
  var $, EditorView, WorkspaceView, path, _, _ref;
    ...
    describe("finding", function() {
      ...
      describe("when the find string contains an escaped char", function() {
        ...
        describe("when regex seach is enabled", function() {
          beforeEach(function() {
            return findView.findEditor.trigger('find-and-replace:toggle-regex-option');
          });
      ...
      describe("when the active pane item changes", function() {
        ...
        describe("when the active pane item is not an edit session", function() {
          ...
          beforeEach(function() {
            ...
            return atom.workspace.registerOpener(anotherOpener);
          });
          afterEach(function() {
            return atom.workspace.unregisterOpener(anotherOpener);
          });
