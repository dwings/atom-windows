(function() {
  ...
  module.exports = EditorView = (function(_super) {
    ...
    EditorView.prototype.bindKeys = function() {
      ...
      editorBindings = {
        ...
        'editor:delete-to-beginning-of-word': (function(_this) {
          return function() {
            return _this.editor.deleteToBeginningOfWord();
          };
        })(this),
        'editor:delete-to-beginning-of-line': (function(_this) {
          return function() {
            return _this.editor.deleteToBeginningOfLine();
          };
        })(this),
        ...
        'editor:move-to-beginning-of-next-paragraph': (function(_this) {
          return function() {
            return _this.editor.moveCursorToBeginningOfNextParagraph();
          };
        })(this),
        'editor:move-to-beginning-of-previous-paragraph': (function(_this) {
          return function() {
            return _this.editor.moveCursorToBeginningOfPreviousParagraph();
          };
        })(this),
      ...
      if (!this.mini) {
        _.extend(editorBindings, {
          ...
          'editor:fold-selection': (function(_this) {
            return function() {
              return _this.editor.foldSelectedLines();
            };
          })(this),
          ...
          'editor:duplicate-lines': (function(_this) {
            return function() {
              return _this.editor.duplicateLines();
            };
          })(this),
    ...
    EditorView.prototype.configure = function() {
      ...
      this.subscribe(atom.config.observe('editor.fontFamily', (function(_this) {
        return function(fontFamily) {
          return _this.setFontFamily(fontFamily);
        };
      })(this)));
      return this.subscribe(atom.config.observe('editor.lineHeight', (function(_this) {
        return function(lineHeight) {
          return _this.setLineHeight(lineHeight);
        };
      })(this)));
    };
    ...
    EditorView.prototype.handleEvents = function() {
      ...
      this.renderedLines.on('mousedown', (function(_this) {
        return function(e) {
          ...
          if (clickCount === 1) {
            if (e.metaKey || (process.platform !== 'darwin' && e.ctrlKey)) {
      ...
      this.scrollView.on('overflowchanged', (function(_this) {
        return function() {
      ...
      return this.subscribe(atom.themes, 'stylesheets-changed', (function(_this) {
        return function() {
          return _this.recalculateDimensions();
        };
      })(this));
    };
    ...
    EditorView.prototype.handleInputEvents = function() {
      ...
      lastInput = '';
      this.on("textInput", (function(_this) {
        return function(e) {
          var selectedLength;
    ...
    EditorView.prototype.selectOnMousemoveUntilMouseup = function() {
      var finalizeSelections, interval, lastMoveEvent, moveHandler;
      lastMoveEvent = null;
      finalizeSelections = (function(_this) {
        return function() {
          ...
          if (!_this.editor.isDestroyed()) {
            _this.editor.mergeIntersectingSelections({
              reversed: _this.editor.getLastSelection().isReversed()
            });
      ...
      moveHandler = (function(_this) {
        return function(event) {
          ...
          if (event.which === 1 && _this[0].style.display !== 'none') {
      ...
      return $(document).one("mouseup.editor-" + this.id, finalizeSelections);
    };
    ...
    EditorView.prototype.edit = function(editor) {
      ...
      this.subscribe(this.editor, "contents-conflicted", (function(_this) {
        return function() {
      ...
      this.subscribe(this.editor, 'selection-added', (function(_this) {
      ...
      this.subscribe(this.editor, 'screen-lines-changed', (function(_this) {
        return function(e) {
          return _this.handleScreenLinesChange(e);
        };
      })(this));
      this.subscribe(this.editor, 'scroll-top-changed', (function(_this) {
        return function(scrollTop) {
          return _this.scrollTop(scrollTop);
        };
      })(this));
      this.subscribe(this.editor, 'scroll-left-changed', (function(_this) {
    ...
    EditorView.prototype.calculateWidthInChars = function() {
      return Math.floor((this.scrollView.width() - this.getScrollbarWidth()) / this.charWidth);
    };
    ...
    EditorView.prototype.getScrollbarWidth = function() {
      var scrollbarElement;
      scrollbarElement = this.verticalScrollbar[0];
      return scrollbarElement.offsetWidth - scrollbarElement.clientWidth;
    };
    ...
    EditorView.prototype.setLineHeight = function(lineHeight) {
      if (this.mini) {
        return;
      }
    ...
    EditorView.prototype.recalculateDimensions = function() {
      var oldCharWidth, oldLineHeight;
      if (!(this.attached && this.isVisible())) {
        return;
      }
      oldCharWidth = this.charWidth;
      oldLineHeight = this.lineHeight;
      this.calculateDimensions();
      if (!(this.charWidth === oldCharWidth && this.lineHeight === oldLineHeight)) {
        this.clearCharacterWidthCache();
        return this.requestDisplayUpdate();
      }
    };

    EditorView.prototype.updateLayerDimensions = function(scrollViewWidth) {
      var height, minWidth;
      ...
      minWidth = Math.max(this.charWidth * this.editor.getMaxScreenLineLength() + 20, scrollViewWidth);
    ...
    EditorView.prototype.updateDisplay = function(options) {
      ...
      scrollViewWidth = this.scrollView.width();
      this.updateRenderedLines(scrollViewWidth);
      this.updatePlaceholderText();
      this.highlightCursorLine();
      this.updateCursorViews();
      this.updateSelectionViews();
      this.autoscroll((_ref2 = options != null ? options.suppressAutoscroll : void 0) != null ? _ref2 : false);
    ...
    EditorView.prototype.syncCursorAnimations = function() {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        cursorView = _ref2[_i];
        _results.push(cursorView.resetBlinking());
      }
      return _results;
    };

    EditorView.prototype.autoscroll = function(suppressAutoscroll) {
      var cursorView, selectionView, _i, _j, _len, _len1, _ref2, _ref3, _results;
      _ref2 = this.getCursorViews();
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        cursorView = _ref2[_i];
        if (!suppressAutoscroll && cursorView.needsAutoscroll()) {
      ...
      for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
        selectionView = _ref3[_j];
        if (!suppressAutoscroll && selectionView.needsAutoscroll()) {
    ...
    EditorView.prototype.updateRenderedLines = function(scrollViewWidth) {
      ...
      this.updateLayerDimensions(scrollViewWidth);
    ...
    EditorView.prototype.positionLeftForLineAndColumn = function(lineElement, screenRow, screenColumn) {
      var bufferChar, index, left, renderedChar, textContent, token, tokenizedLine, val, _i, _j, _len, _len1, _ref2, _ref3;
      if (screenColumn === 0) {
        return 0;
      }
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
          ...
          val = this.getCharacterWidthCache(token.scopes, renderedChar);
          if (val != null) {
            left += val;
          } else {
    ...
    EditorView.buildLineHtml = function(_arg) {
      var attributeName, attributePairs, attributes, editor, eolInvisibles, firstTrailingWhitespacePosition, fold, hasIndentGuide, html, htmlEolInvisibles, indentation, invisibles, isSoftWrapped, line, lineEnding, lineIsWhitespaceOnly, mini, position, scopeStack, showIndentGuide, text, token, tokens, value, _i, _len;
