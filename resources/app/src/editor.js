(function() {
  ...
  module.exports = Editor = (function(_super) {
    ...
    Editor.prototype.updateBatchDepth = 0;
    ...
    Editor.delegatesProperties('$lineHeightInPixels', '$defaultCharWidth', '$height', '$width', '$scrollTop', '$scrollLeft', 'manageScrollPosition', {
    ...
    function Editor(_arg) {
      ...
      this.softTabs = (_ref1 = (_ref2 = (_ref3 = this.usesSoftTabs()) != null ? _ref3 : this.softTabs) != null ? _ref2 : atom.config.get('editor.softTabs')) != null ? _ref1 : true;
    ...
    Editor.prototype.subscribeToDisplayBuffer = function() {
      ...
      this.subscribe(this.displayBuffer, 'tokenized', (function(_this) {
        return function() {
    ...
    Editor.prototype.usesSoftTabs = function() {
      var bufferRow, match, _i, _ref1;
      for (bufferRow = _i = 0, _ref1 = this.buffer.getLastRow(); 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; bufferRow = 0 <= _ref1 ? ++_i : --_i) {
        if (this.displayBuffer.tokenizedBuffer.lineForScreenRow(bufferRow).isComment()) {
          continue;
        }
        if (match = this.buffer.lineForRow(bufferRow).match(/^\s/)) {
          return match[0][0] !== '\t';
        }
      }
      return void 0;
    ...
    Editor.prototype.deleteToBeginningOfWord = function() {
      return this.mutateSelectedText(function(selection) {
        return selection.deleteToBeginningOfWord();
      });
    };

    Editor.prototype.deleteToBeginningOfLine = function() {
      return this.mutateSelectedText(function(selection) {
    ...
    Editor.prototype.pasteText = function(options) {
      ...
      if (((metadata != null ? metadata.selections : void 0) != null) && metadata.selections.length === this.getSelections().length) {
        this.mutateSelectedText(function(selection, index) {
    ...
    Editor.prototype.selectionsForScreenRows = function(startRow, endRow) {
    ...
    Editor.prototype.moveCursorToBeginningOfNextParagraph = function() {
      return this.moveCursors(function(cursor) {
        return cursor.moveToBeginningOfNextParagraph();
      });
    };

    Editor.prototype.moveCursorToBeginningOfPreviousParagraph = function() {
      return this.moveCursors(function(cursor) {
    ...
    Editor.prototype.handleTokenization = function() {
      var _ref1;
      return this.softTabs = (_ref1 = this.usesSoftTabs()) != null ? _ref1 : this.softTabs;
    };
    ...
    Editor.prototype.getLineHeightInPixels = function() {
      return this.displayBuffer.getLineHeightInPixels();
    };

    Editor.prototype.setLineHeightInPixels = function(lineHeightInPixels) {
    ...
    Editor.prototype.horizontallyScrollable = function() {
      return this.displayBuffer.horizontallyScrollable();
    };

    Editor.prototype.verticallyScrollable = function() {
      return this.displayBuffer.verticallyScrollable();
    };

    Editor.prototype.getHorizontalScrollbarHeight = function() {
      return this.displayBuffer.getHorizontalScrollbarHeight();
    };

    Editor.prototype.setHorizontalScrollbarHeight = function(height) {
      return this.displayBuffer.setHorizontalScrollbarHeight(height);
    };

    Editor.prototype.getVerticalScrollbarWidth = function() {
      return this.displayBuffer.getVerticalScrollbarWidth();
    };

    Editor.prototype.setVerticalScrollbarWidth = function(width) {
