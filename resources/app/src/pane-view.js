(function() {
  var $, Delegator, Pane, PaneView, PropertyAccessors, View, deprecate, _ref,
  ...
  module.exports = PaneView = (function(_super) {
    ...
    PaneView.prototype.onActiveItemChanged = function(item) {
      var hasFocus, otherView, view, _i, _len, _ref1, _ref2;
      ...
      _ref2 = this.itemViews.children().not(view).views();
