(function() {
  var $, EditorView, SelectListView, View, fuzzyFilter, _ref,
  ...
  module.exports = SelectListView = (function(_super) {
    ...
    SelectListView.content = function() {
      return this.div({
        ...
        return function() {
          _this.subview('filterEditorView', new EditorView({
            mini: true
          }));
          _this.div({
            "class": 'error-message',
    ...
    SelectListView.prototype.initialize = function() {
      this.filterEditorView.getEditor().getBuffer().on('changed', (function(_this) {
        return function() {
          return _this.schedulePopulateList();
        };
      })(this));
      this.filterEditorView.hiddenInput.on('focusout', (function(_this) {
        return function() {
          if (!_this.cancelling) {
            return _this.cancel();
          }
    ...
    SelectListView.prototype.cancelled = function() {
      this.filterEditorView.getEditor().setText('');
      return this.filterEditorView.updateDisplay();
    };
