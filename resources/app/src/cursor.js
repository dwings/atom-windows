(function() {
  var Cursor, Model, Point, Range, _, _ref,
  ...
  module.exports = Cursor = (function(_super) {
    ...
    Cursor.prototype.autoscroll = function() {
    ...
    Cursor.prototype.getBeginningOfCurrentWordBufferPosition = function(options) {
      ...
      this.editor.backwardsScanInBufferRange((_ref3 = options.wordRegex) != null ? _ref3 : this.wordRegExp(options), scanRange, (function(_this) {
        return function(_arg) {
          var range, stop;
    ...
    Cursor.prototype.getBeginningOfNextParagraphBufferPosition = function(editor) {
    ...
    Cursor.prototype.getBeginningOfPreviousParagraphBufferPosition = function(editor) {
