(function() {
  ...
  module.exports = PackageManager = (function() {
    ...
    function PackageManager(_arg) {
      var configDirPath, devMode, safeMode;
      configDirPath = _arg.configDirPath, devMode = _arg.devMode, safeMode = _arg.safeMode, this.resourcePath = _arg.resourcePath;
    ...
    PackageManager.prototype.getApmPath = function() {
      ...
      return this.apmPath != null ? this.apmPath : this.apmPath = path.resolve(__dirname, '..', 'apm', 'node_modules', 'atom-package-manager', 'bin', commandName);
    };
