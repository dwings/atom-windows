(function() {
  var Directory, Editor, Emitter, Git, Model, Project, Q, Serializable, Subscriber, Task, TextBuffer, deprecate, fs, path, url, _, _ref,
  ...
  module.exports = Project = (function(_super) {
    ...
    Project.prototype.setPath = function(projectPath) {
      ...
      if (projectPath != null) {
        ...
        if (this.repo = Git.open(directory, {
          project: this
        })) {
    ...
    Project.prototype.resolve = function(uri) {
      ...
      if (uri != null ? uri.match(/[A-Za-z0-9+-.]+:\/\//) : void 0) {
        ...
        } else if (projectPath = this.getPath()) {
          return fs.absolute(path.join(projectPath, uri));
        } else {
          return void 0;
        }
      }
