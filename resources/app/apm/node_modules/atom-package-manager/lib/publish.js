(function() {
  var Command, Git, Login, Packages, Publish, auth, config, fs, optimist, path, request,
  ...
  module.exports = Publish = (function(_super) {
    ...
    Publish.prototype.getToken = function(callback) {
    ...
    Publish.prototype.packageExists = function(packageName, callback) {
      return this.getToken(function(error, token) {
        var requestSettings;
        if (error != null) {
          callback(error);
          return;
    ...
    Publish.prototype.registerPackage = function(pack, callback) {
      ...
      return this.packageExists(pack.name, (function(_this) {
        return function(error, exists) {
          ...
          return _this.getToken(function(error, token) {
            var requestSettings;
            if (error != null) {
              _this.logFailure();
              callback(error);
